...
const SignUp = () => {
  ...
  const onSubmit = async (formData) => {
    ...
    try {
        const fetchResponse = await fetch(`${BASE_URL}/api/signup`, settings);
      ...
      <div className="home-wrapper">
        <header className="home">
          ...
          <form className="home__form" onSubmit={handleSubmit(onSubmit)}>
            ...
            {errors.password_confirmation && <p className="home__form--error">{errors.password_confirmation.message}</p>}
            <div className="home__form--field">
            ...
            <HiOutlineUserCircle className="home__form--icon" />
              ...
              <button 
                ...
                type="submit" 
              >Create Account <FaUserPlus /></button>
          </form>
